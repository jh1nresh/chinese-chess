...
// Xiangqi adds a cannon rank. Reuse the existing staff-bearing mage sculpt so
// the original 3D army stays intact and cannon captures still read at range.
PIECE_MODEL_URLS.w.c = PIECE_MODEL_URLS.w.b;
PIECE_MODEL_URLS.b.c = PIECE_MODEL_URLS.b.b;
...
PIECE_ANIMATED_MODELS.w.c = PIECE_ANIMATED_MODELS.w.b;
PIECE_ANIMATED_MODELS.b.c = PIECE_ANIMATED_MODELS.b.b;
...
export const DEATH_CRY_URLS: Record<Faction, Record<PieceKind, string>> = {
  w: {
    ...
    c: `${CRY_BASE}/4ca6a216-52fc-4882-b51a-9a44d188edac.mp3`,
  },
  b: {
