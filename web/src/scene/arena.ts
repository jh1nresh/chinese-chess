...
export interface ArenaLook {
  ...
  birds: number;
  /** Siege engines and ruined war props. Off where they make no sense. */
...
export const ARENA_LOOKS: Record<ArenaTheme, ArenaLook> = {
  /**
   * Mountain temple in a jade forest: dark pines, vermilion halls and gilded
   * eaves. The cool green surround keeps the red army sharply legible.
   */
  jungle: {
    id: "jungle",
    label: "蒼龍山寺",
    note: "松林山寺、朱紅飛簷與金色晨光，紅方輪廓最鮮明",
    exposure: 0.95,
    background: 0x7fb0c4,
    ...
    flora: {
      ...
      vine: 0x4f7d36,
      frond: 0x63993a,
      temple: { stone: 0x9b927f, moss: 0x6f241e, gold: 0xd8ae55 },
      beam: { color: 0xffe6a6, opacity: 0.3 },
      pollen: { color: 0xffe6a0, opacity: 0.42 },
    },
    board: { light: 0xddc79b, dark: 0xcfb789, base: 0x515a41, border: 0xc3a86a, trim: 0xd7a93f },
  ...
  dawn: {
    ...
    siegeEngines: true,
    flora: NO_FLORA,
    board: { light: 0xe0cda6, dark: 0xd2bd91, base: 0x554d40, border: 0xb2a17c, trim: 0x957336 },
  ...
  frost: {
    ...
    siegeEngines: true,
    flora: NO_FLORA,
    board: { light: 0xd8c9a9, dark: 0xc9b795, base: 0x4b5260, border: 0xb3bdc8, trim: 0x77869a },
  ...
  dusk: {
    ...
    siegeEngines: true,
    flora: NO_FLORA,
    board: { light: 0xd8bd8e, dark: 0xc9ab7b, base: 0x3b342b, border: 0xbfae8e, trim: 0x8a6a33 },
