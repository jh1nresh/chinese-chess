...
function applyFactionLook(
  ...
  if (ownLivery && material.map) {
    ...
    material.color.setHex(color === "w" ? 0xcf665c : 0x62636a);
    ...
    material.emissive = new THREE.Color(color === "w" ? 0x7a160f : 0x111217);
  ...
  if (color === "w") {
    material.color.setHex(0xb83b32);
    material.roughness = 0.34;
    material.metalness = 0.1;
    material.emissive = new THREE.Color(0x5d100b);
  } else {
    material.color.setHex(0x25272c);
    material.roughness = 0.3;
    material.metalness = 0.55;
    material.emissive = new THREE.Color(0x08090c);
  }
  material.emissiveIntensity = 0.05;
