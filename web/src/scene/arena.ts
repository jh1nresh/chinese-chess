...
export const ARENA_LOOKS: Record<ArenaTheme, ArenaLook> = {
  ...
  jungle: {
    ...
    board: { light: 0xddc79b, dark: 0xddc79b, base: 0x515a41, border: 0xc3a86a, trim: 0xd7a93f },
  ...
  dawn: {
    ...
    siegeEngines: true,
    flora: NO_FLORA,
    board: { light: 0xe0cda6, dark: 0xe0cda6, base: 0x554d40, border: 0xb2a17c, trim: 0x957336 },
  ...
  frost: {
    ...
    siegeEngines: true,
    flora: NO_FLORA,
    board: { light: 0xd8c9a9, dark: 0xd8c9a9, base: 0x4b5260, border: 0xb3bdc8, trim: 0x77869a },
  ...
  dusk: {
    ...
    siegeEngines: true,
    flora: NO_FLORA,
    board: { light: 0xd8bd8e, dark: 0xd8bd8e, base: 0x3b342b, border: 0xbfae8e, trim: 0x8a6a33 },
