  ...
  return (
    <svg width={size} height={size * 1.15} viewBox="0 0 40 46" aria-hidden="true">
      ...
      <text
        ...
        textAnchor="middle"
        fill={charge}
        fontFamily="KaiTi, STKaiti, DFKai-SB, serif"
        fontSize="20"
        fontWeight="700"
      >
        {faction === "w" ? "漢" : "楚"}
...
const GLYPHS: Record<Faction, Record<PieceKind, string>> = {
  w: { k: "帥", q: "仕", b: "相", n: "馬", r: "俥", c: "炮", p: "兵" },
  b: { k: "將", q: "士", b: "象", n: "馬", r: "車", c: "砲", p: "卒" },
};

export function pieceGlyph(kind: PieceKind, faction: Faction): string {
  return GLYPHS[faction][kind];
}
